sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zsapui5proj06fullscreen/ZSAPUI5_Proj06_FullScreen/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#SAPDataBaseTables-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#SAPDataBaseTables-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("zsapui5proj06fullscreen.ZSAPUI5_Proj06_FullScreen.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zsapui5proj06fullscreen/ZSAPUI5_Proj06_FullScreen/localService/mockserver"], function (mockserver) {
